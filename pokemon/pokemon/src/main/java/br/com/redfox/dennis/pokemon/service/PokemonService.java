...
public class PokemonService {
	...
	public Page<Pokemon> ListById(int page){
		...
		return pokemonRepository.findAllOrderByIdAsc(pag);
	...
	public Page<Pokemon> ListByName(int page){
		Pages pag = new Pages(page, 0);
		return pokemonRepository.findAllOrderByNameAsc(pag);
	}
	
	@Transactional
	public Page<Pokemon> ListByStatusTotal(int page){
		Pages pag = new Pages(page, 0);
		return pokemonRepository.findAllOrderBystatusTotalAsc(pag);
	}
